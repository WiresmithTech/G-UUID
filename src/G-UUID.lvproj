...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="tests" Type="Folder">
			<Item Name="UUID Structure Tests.lvclass" Type="LVClass" URL="../tests/UUID Structure Tests/UUID Structure Tests.lvclass"/>
		</Item>
		<Item Name="Generate UUID V4 (Random).vi" Type="VI" URL="../Generate UUID V4 (Random).vi"/>
		<Item Name="UUID.lvclass" Type="LVClass" URL="../UUID/UUID.lvclass"/>
